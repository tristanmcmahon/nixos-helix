...
assert config.services.netdata.config.global."config directory" == "/run/netdata/conf.d";
...
assert config.services.netdata.configDir ? "go.d/nvidia_smi.conf";
assert config.services.netdata.configDir ? "go.d/smartctl.conf";
assert config.services.netdata.configDir ? "go.d/systemdunits.conf";
