...
assert config.helix.networking.pihole.address == "192.168.1.8";
assert config.networking.networkmanager.enable;
assert config.networking.networkmanager.dns == "none";
assert config.networking.nameservers == [ config.helix.networking.pihole.address ];
